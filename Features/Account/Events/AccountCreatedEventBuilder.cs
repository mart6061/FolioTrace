...
public static class AccountCreatedEventBuilder
{
    ...
    public static Result<AccountCreatedEvent> Create(UserID userId, EventDateTime eventDateTime, string reason, AccountID accountID, string name, string formalName, Alpha3 bookCurrency, bool active, Currencies? currencies = null, Accounts? accounts = null)
    {
    ...
    public static Result<AccountCreatedEvent> CreateSeed(EventID eventId, UserID userId, EventDateTime eventDateTime, AuditDateTime auditDateTime, string reason, AccountID accountID, string name, string formalName, Alpha3 bookCurrency, bool active, Currencies? currencies = null, Accounts? accounts = null)
    {
