...
public static class UserValuationPreferencesCreatedEventBuilder
{
    ...
    public static Result<UserValuationPreferencesCreatedEvent> Create(UserID userID, EventDateTime eventDateTime, string reason, UserValuationDateOption valuationDateOption, ValuationDateBasis valuationDateBasis, bool showZeroBalances)
    {
    ...
    public static Result<UserValuationPreferencesCreatedEvent> CreateSeed(EventID eventID, UserID userID, EventDateTime eventDateTime, AuditDateTime auditDateTime, string reason, UserValuationDateOption valuationDateOption, ValuationDateBasis valuationDateBasis, bool showZeroBalances)
    {
        ...
        return validationErrors.Count == 0
            ? Result<UserValuationPreferencesCreatedEvent>.Success(new UserValuationPreferencesCreatedEvent(eventID, userID, eventDateTime, auditDateTime, reason, valuationDateOption, valuationDateBasis, showZeroBalances))
