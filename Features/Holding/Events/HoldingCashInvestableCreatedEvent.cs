...
public sealed record HoldingCashInvestableCreatedEvent : HoldingBankCreatedEvent
{
    [JsonConstructor]
    ...
    internal override Holding CreateHolding() => new HoldingCashInvestable(HoldingID, AccountID, InstrumentID, Name, Active, Default, EventDateTime, AuditDateTime, EventID, AuditDateTime, BankName, AccountName, SortCode, AccountNumber, BIC, IBAN);
}
