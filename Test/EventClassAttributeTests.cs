...
public sealed class EventClassAttributeTests
{
    ...
    [
        ...
        nameof(TicketFIXRequestedEvent),
        nameof(TicketTradeFilePendingEvent),
        nameof(TicketTradeFileRequestedEvent),
        nameof(TicketTradeFileSentEvent),
        nameof(TicketTradeFileAcknowledgedEvent),
        nameof(TicketTradeExecutionInProgressEvent),
        nameof(TicketTradeExecutionFailedEvent),
        nameof(TradeFileRequestedEvent),
        nameof(TradeFileSentEvent),
        nameof(TradeFileAcknowledgedEvent),
        nameof(TradeFileTicketConfirmedEvent),
        nameof(TradeFileCompletedEvent),
        nameof(TradeFileFailedEvent),
