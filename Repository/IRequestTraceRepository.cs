...
public interface IRequestTraceRepository
{
    ...
    Task AppendAsync(IReadOnlyCollection<RequestTraceEvent> traceEvents, CancellationToken cancellationToken = default);
    ...
    Task<int> PurgeLegacyUiEventsAsync(CancellationToken cancellationToken = default);
