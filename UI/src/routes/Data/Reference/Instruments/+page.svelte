                ...
                <tr class="bg-teal-50/30 align-top">
                  ...
                  <td class="px-3 py-2">
                    <label class="grid gap-1 text-xs font-medium text-slate-600" form="instrument-create">
                      ...
                      <input class="h-8 w-44 rounded-md border border-slate-300 bg-white px-2 text-sm text-slate-950 outline-none focus:border-teal-600 focus:ring-2 focus:ring-teal-600/20" form="instrument-create" name="eventDateTime" required type="datetime-local" value={createValue('eventDateTime') || data.valuationDate} />
                    </label>
                  </td>
                ...
                {#if editingInstrumentID === instrument.instrumentID}
                  <tr class="bg-teal-50/30 align-top">
                    ...
                    <td class="px-3 py-2">
                      <label class="grid gap-1 text-xs font-medium text-slate-600" form={`instrument-edit-${instrument.instrumentID}`}>
                        <span>Event date</span>
                        <input class="h-8 w-44 rounded-md border border-slate-300 bg-white px-2 text-sm text-slate-950 outline-none focus:border-teal-600 focus:ring-2 focus:ring-teal-600/20" form={`instrument-edit-${instrument.instrumentID}`} name="eventDateTime" required type="datetime-local" value={editValue(instrument.instrumentID, 'eventDateTime') ?? data.valuationDate} />
                      </label>
                    </td>
                    <td class="sticky right-0 bg-teal-50 px-3 py-2 shadow-[-8px_0_12px_-12px_rgba(15,23,42,0.6)]">
                      <div class="grid justify-end gap-1 text-xs font-medium text-slate-600">
