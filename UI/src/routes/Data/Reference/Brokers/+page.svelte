                      ...
                      <td class="px-3 py-3" colspan="9">
                        <div class="grid gap-3 rounded-md border border-slate-200 bg-white p-3">
                          <div class="flex items-center justify-between gap-3">
                            <h2 class="text-sm font-semibold text-slate-950">{broker.lei} history</h2>
                              ...
                              {#each history.events as event (event.eventID)}
                                <li class={`grid gap-2 rounded-md border px-3 py-2 md:grid-cols-[180px_1fr] ${
                                  ...
                                  <div class="grid gap-1">
                                    ...
                                    <div class="text-sm text-slate-700">{brokerEventSummary(event)}</div>
                          ...
                          {:else}
                            <div class="text-sm text-slate-600">No history found for this broker.</div>
                          {/if}
                        </div>
                      </td>
                    </tr>
