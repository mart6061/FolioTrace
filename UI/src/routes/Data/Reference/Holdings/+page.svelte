                ...
                <tr class="bg-teal-50/30 align-top">
                  ...
                  <td class="px-3 py-2">
                    <label class="grid gap-1 text-xs font-medium text-slate-600" form="holding-create">
                      ...
                      <DateTimeInput class="h-8 w-44 rounded-md border border-slate-300 bg-white px-2 text-sm text-slate-950 outline-none focus:border-teal-600 focus:ring-2 focus:ring-teal-600/20" form="holding-create" name="eventDateTime" required step="1" value={data.valuationDate} />
                    </label>
                  </td>
                  <td class="px-3 py-2">
                  ...
                  <tr class="bg-teal-50/30 align-top">
                    ...
                    <td class="px-3 py-2">
                      <label class="grid gap-1 text-xs font-medium text-slate-600" form={`holding-edit-${holding.holdingID}`}>
                        <span>Event date</span>
                        <DateTimeInput class="h-8 w-44 rounded-md border border-slate-300 bg-white px-2 text-sm text-slate-950 outline-none focus:border-teal-600 focus:ring-2 focus:ring-teal-600/20" form={`holding-edit-${holding.holdingID}`} name="eventDateTime" required step="1" value={data.valuationDate} />
                      </label>
                    </td>
                    <td class="px-3 py-2">
                      <div class="flex justify-end gap-2">
